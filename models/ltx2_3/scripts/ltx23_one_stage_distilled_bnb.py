"""
LTX 2.3 One-Stage Distilled Text-to-Video Inference Script (BNB NF4 quantized)
...
BNB_4BIT_MODEL_PATH = "OzzyGT/LTX-2.3-Distilled-bnb-nf4"
...
output_path = f"outputs/ltx23/ltx23_one_stage_distilled_bnb_4bit_{width}x{height}_{seconds}s_seed{seed}.mp4"
encode_video(
    video[0],
    fps=frame_rate,
