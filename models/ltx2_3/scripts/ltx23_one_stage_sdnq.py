...
SDNQ_4BIT_MODEL_PATH = "OzzyGT/LTX-2.3-sdnq-dynamic-int4"
SDNQ_8BIT_MODEL_PATH = "OzzyGT/LTX-2.3-sdnq-dynamic-int8"
SDNQ_BITS = 4  # 4 or 8
...
output_path = f"outputs/ltx23/ltx23_one_stage_sdnq_{SDNQ_BITS}bit_{width}x{height}_{seconds}s_seed{seed}.mp4"
encode_video(
    video[0],
    fps=frame_rate,
