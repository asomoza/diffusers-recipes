...
SDNQ_BITS = 8  # 4 or 8
BASE_MODEL = f"OzzyGT/LTX-2.3-sdnq-dynamic-int{SDNQ_BITS}"
...
OUTPUT_PATH = f"outputs/ltx23/ltx23_image_audio_conditioning_{WIDTH}x{HEIGHT}_{SECONDS}s_seed{SEED}.mp4"
