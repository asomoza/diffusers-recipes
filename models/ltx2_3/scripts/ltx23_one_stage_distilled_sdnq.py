"""
LTX 2.3 One-Stage Distilled Text-to-Video Inference Script (SDNQ quantized)
...
output_path = f"outputs/ltx23/ltx23_one_stage_distilled_sdnq_{SDNQ_BITS}bit_{width}x{height}_{seconds}s_seed{seed}.mp4"
encode_video(
    video[0],
    fps=frame_rate,
