...
IMAGE_PATH = "https://huggingface.co/datasets/OzzyGT/diffusers-examples/resolve/main/ltx2/20260409145818.png"
...
embeds_pipe = LTX2ImageToVideoPipeline.from_pretrained(
    MODEL_PATH,
...
encode_video(
    ...
    output_path="./outputs/ltx23/i2v_sdnq_one_stage_distilled_steps.mp4",
)
