...
SDNQ_BITS = 4  # 4 or 8
BASE_MODEL = f"OzzyGT/LTX-2.3-Distilled-1.1-sdnq-dynamic-int{SDNQ_BITS}"
...
PROMPT = """the man plays the guitar and sings on an old western town"""
...
IMAGE_URL = "https://huggingface.co/datasets/OzzyGT/diffusers-examples/resolve/main/ltx2/man_guitar.png"
AUDIO_URL = "https://huggingface.co/datasets/OzzyGT/diffusers-examples/resolve/main/ltx2/diff_vocal_song.mp3"
...
OUTPUT_PATH = f"outputs/ltx23/ltx23_image_audio_sync_{WIDTH}x{HEIGHT}_{SECONDS}s_seed{SEED}.mp4"
