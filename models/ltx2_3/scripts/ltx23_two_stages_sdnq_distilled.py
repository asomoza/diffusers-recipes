...
output_path = f"outputs/ltx23/ltx23_two_stage_sdnq_distilled_s1_{STAGE_1_SDNQ_BITS}bit_s2_{STAGE_2_SDNQ_BITS}bit_{width}x{height}_{seconds}s_seed_{seed}.mp4"
encode_video(
    video[0],
    fps=frame_rate,
