...
SDNQ_4BIT_MODEL_PATH = "OzzyGT/ERNIE_Image_sdnq_dynamic_int4"
SDNQ_8BIT_MODEL_PATH = "OzzyGT/ERNIE_Image_sdnq_dynamic_int8"
SDNQ_BITS = 4  # 4 or 8
...
image = pipe(
    ...
    guidance_scale=4.0,
    use_pe=USE_PROMPT_ENHANCER,  # use prompt enhancer
    generator=generator,
).images[0]

os.makedirs("outputs/ernie_image", exist_ok=True)
output_path = f"outputs/ernie_image/ernie_sdnq_{SDNQ_BITS}bit_{width}x{height}_{seed}.png"
